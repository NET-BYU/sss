                ...
                if keyboard.is_pressed('g'):
                    ...
                    while True:
                        ...
                        if keyboard.is_pressed('b'):
                            client.publish("byu_ssdd/output/nav", "controller.html?right=True&left=True")
                            breakout.breakout(500)

                        # Snake Game    
                        elif keyboard.is_pressed('s'):
                            client.publish("byu_ssdd/output/nav", "controller.html?right=True&left=True&up=True&left=True")
                            while True:
                                print("snek")
                                pass
                        ...
                        # Pong Game    
                            ...
                            client.publish("byu_ssdd/output/nav", "controller.html?down=True&up=True")
                            # snake()
                            pass
